...
type OperationLog struct {
	...
	Query     string    `json:"query" gorm:"column:query;type:varchar(225);comment:'查询内容'"`                    // 查询内容
	...
	UserAgent string    `json:"userAgent" gorm:"column:user_agent;type:varchar(225);comment:'浏览器标识'"`          // 浏览器标识
