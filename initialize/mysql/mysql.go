...
func MysqlInit(config config.MysqlConfig) { // mysql主从一致
...
// 主库
func mysqlInitMaster(config config.MysqlConfig) {
	var err error
...
// 从库0
func mysqlInitSlave0(config config.MysqlConfig) {
	var err error
...
// 从库1
func mysqlInitSlave1(config config.MysqlConfig) {
	var err error
